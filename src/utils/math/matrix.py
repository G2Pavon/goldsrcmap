...
class Matrix3x3:
    ...
    @classmethod
    def rotation_x(cls, angle: Union[int, float]) -> 'Matrix3x3':
    ...
    @classmethod
    def rotation_y(cls, angle: Union[int, float]) -> 'Matrix3x3':
        if isinstance(angle, (int, float)):
            theta = radians(angle)
    ...
    @classmethod
    def rotation_z(cls, angle: Union[int, float]) -> 'Matrix3x3':
        if isinstance(angle, (int, float)):
            theta = radians(angle)
    ...
    @classmethod
    def rotation_xyz(cls, phi: Union[int, float], theta: Union[int, float], psi: Union[int, float]) -> 'Matrix3x3':
    ...
    @classmethod
    def rotate_around_axis(cls, angle: Union[int, float], axis: Vector3) -> 'Matrix3x3':
        if isinstance(angle, (int, float)):
            angle = radians(angle)
            c = cos(angle)
            s = sin(angle)
